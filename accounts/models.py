...
class Order(models.Model):
    ...
    customer = models.ForeignKey(Customer, null=True, on_delete=models.SET_NULL) # order will remain in the db if customer is deleted
    product = models.ForeignKey(Product, null=True, on_delete=models.SET_NULL) # order will remain in the db if customer is deleted
    date_created = models.DateTimeField(auto_now_add=True, null=True)
